//! The complete X11 color name table graphviz ships
//! (`lib/common/color_names`, 679 entries), generated from that file.
//! Case-insensitive lookup, matching graphviz's `colorxlate`.

use gpui_kit::Hsla;

/// `(name, rgba)` — sorted by name for binary search.
...
/// Resolves an X11 color name (case-insensitive). Colors whose alpha is
